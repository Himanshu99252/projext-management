...
function TasksList() {
    return (
        <div className="ml-12 mt-11 flex-col flex gap-4 border">
            <Tabs />
...
function Tabs() {
    return (
        <div className="flex items-center gap-6 ml-3 mt-8 mb-5 border">
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <div className="wallet Icon">
                        <div className="bg-orange-200 rounded-lg p-2 flex items-center justify-center">
                            <FormatListBulletedIcon className="text-orange-600" />
                        </div>
                    </div>
                    {/* Task Name */}
